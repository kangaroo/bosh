...
describe Bosh::AwsCloud::Cloud do
  ...
  let(:ami) { 'ami-8fe9d0e6' } # ubuntu-raring-13.04-amd64-server-20130601 on instance store
  ...
  describe 'ec2' do
    ...
    describe 'VM lifecycle with light stemcells' do
      it 'excercises vm lifecycle with light stemcell' do
        expect {
          stemcell_id = cpi.create_stemcell('/not/a/real/path', { 'ami' => { 'us-east-1' => 'ami-8fe9d0e6' } })
